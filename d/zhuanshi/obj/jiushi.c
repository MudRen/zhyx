...
void create()
{
        ...
        {
                set("long", HIR"这是一柄四尺来长，全身通红，出自东海拜剑山庄，经山庄三代铸剑师历时百年而成的剑中之王。\n"NOR);
                set("wield_msg", HIW"刹那间，一道气壮山河的黑虹，宛似天际间忽起的闪电一般，出现在众人眼前！\n"NOR);
                set("unwield_msg", HIW"但见$N将$n向天一直，数匹布条随风而起，将$n严严实实地裹了起来！\n"NOR);
                set("unit", "柄");
                set("material", "steel");
                set("value", UNIQUE);
                set("sharpness", 10);
...
int wield()
{
        ...
        int ret;
         ...
         if( !wizardp(me) && me->query("id") != "box" )
        {
                message_vision(HIR"$N的手刚刚触摸到$n的剑柄，突然一股由天而生的力量自剑中穿来，将$N击出丈远！$n也随之掉落地上。\n"NOR, me, ob);
                me->receive_damage("qi", 50000, "被绝世好剑击死了");
                me->receive_wound("qi", 10000, "被绝世好剑击死了");
...
{
                message_vision(HIW+BLK"只见$N将一柄裹在帆布里的长剑缓缓抽出，乌黑的剑身带出来的却是霸王的气势！\n"NOR, me);
                me->add("neili", -200);
