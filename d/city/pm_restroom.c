...
void create()
{
    ...
    set("long", @LONG
这是一个装饰豪华，色调温暖的小房间，到处摆放着各种珍奇
古玩。宽大的真皮沙发柔软舒适，大款们来到这里都会坐下来，讨
论一下泥巴商业运作情况。休息室大门通向金色走廊，另一面墙壁
有一道小门，平常紧闭着，只有在每两月一次的泥巴黑店拍卖时，
巫师才会将之打开。一块小小的牌子(paizi)挂在东面墙上，这是
巫师宣布黑店拍卖底价用的。
LONG );
...
int do_look(string arg)
{
    ...
    msg += HIC "-------------------------------------------------------------------------\n" NOR;
    msg += HIC "一共 " HIR + chinese_number(sizeof(heidian_record)) + HIC " 家黑店\n";
    write(msg);
    return 1;
}