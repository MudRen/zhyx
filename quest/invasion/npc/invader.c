...
#include <ansi.h>
#include <command.h>
#define INVASIOND "/quest/invasion/invasiond"
...
{
     object ob, ob1;
     int exp,pot,tihui,gongxian,weiwang,score, div;
