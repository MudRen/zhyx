...
int main(object me, string arg)
{
        ...
        c = 100 + me->query_temp("apply/learn_times");
        // 特殊物品增加学习次数
        ...
        if ( me->query("env/no_literate")  && skill == "literate")
                return notify_fail("你现在设置了不学习读书写字。要想开启请用unset no_literate\n");

        if (me->query_skill("taixuan-gong", 1) && skill == "literate")
                return notify_fail("你已经学会了太玄功，还要打算学习读书写字吗？\n");
