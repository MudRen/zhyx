...
int main(object me, string arg)
{
	...
	if (result < 0 || environment(me) != env)
     ...
     /*   if (my_temp["is_riding"]
        &&arg !="north"&&arg !="south"
        &&arg !="east"&&arg !="west"
        &&arg !="northup"&&arg !="southdown"
        &&arg !="southup"&&arg !="northdown"
        &&arg !="eastup"&&arg !="westdown"
        &&arg !="westup"&&arg !="eastdown"
        &&arg !="northeast"&&arg !="southwest"
        &&arg !="northwest"&&arg !="southeast"
        &&arg !="up"&&arg !="down"
        &&arg !="enter"&&arg !="out")
