...
// 一等奖(1个) 奖励 神佑果 一个 (可以给指定id获得真命天子属性,成功率100%)
// 二等奖(2个) 奖励 环宇天晶 一个 (高级兵器铸造材料)
// 三等奖(3个) 奖励 神兵卡 一张 (可以到wiz处兑换一把10级兵器)
// 参与奖 (其他所有参加抽奖者均有) 奖励 金帝巧克力 一个 (10万潜能)
...
#define SECOND_PRIZE    /d/death/obj/tianjing"
#define THIRD_PRIZE     "/clone/fam/item/weapon_card"
#define NORMAL_PRIZE    "/u/sanben/obj/jindi"
#define MAX_NUM         200
...
void count_down(int i)
	{	
		 ...
		 message( "story", HIG"【开奖信息】圣诞抽奖结果马上就要公布，请大家做好准备!" +
