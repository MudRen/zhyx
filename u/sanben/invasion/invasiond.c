...
#include <ansi.h>
#define   INVADE_NPC  "/u/sanben/invasion/npc"
...
void set_invader_skill(object ob, int lvl)
{
        ...
        switch(lvl)
        {
         case 1 :
                      ...
                      break;
         case 2 :
                      sk_lvl = 550 + random(50);
                      qi = 40000;
                      rank = HIB"小头目"NOR;
                      break;
         case 3 :
                      sk_lvl = 650 + random(50);
                      rank = HIC"大头目"NOR;
                      qi = 50000;                 
                      break;
         case 4 :
                      sk_lvl = 750 + random(50);
                      qi = 60000;
                      rank = YEL"副司令"NOR;                
                      break;
         case 5 :
                      sk_lvl = 850 + random(50);
                      rank = HIR"总司令"NOR;
                      qi = 70000;             
                      break;
        }
	...
	ob->set_temp("apply/unarmed_damage", 100);
