...
varargs public void bonus(object who, mapping b, int flag)
{
        ...
        // bonus
      /*  who->add("combat_exp", exp*10/8);
        who->add("potential", pot*10/8);
        who->add("experience", mar*10/8);
        who->add("shen", shen*10/8);
        who->add("score", score*10/8);
        who->add("weiwang", weiwang*10/8); */
        ...
        who->add("gongxian", gongxian*10/8);
}
