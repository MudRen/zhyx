...
static string *quest_name = ({
        "family",
});


static object running_quest;
static int step;
int all_enemy = 0;
object *all_killer = ({});
...
mapping family = ([
        ...
        "日月神教" : ({ "/d/heimuya/changtan","/d/heimuya/xingxingtan",
                        "/d/heimuya/shandao1","/d/heimuya/shandao2",
                        "/d/heimuya/shijie1","/d/heimuya/shijie2",
                        "/d/heimuya/shimen","/d/heimuya/up1", }),
...
void process_quest(object ob)
{
        ...
        {
                listeners = users();
           listeners = filter_array(listeners, (: !$1->query("env/no_waidi") :));
