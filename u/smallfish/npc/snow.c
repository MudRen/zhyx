...
void relay_emote(object ob, string verb)
{
   ...
   command ("die "+ ob->query("id"));
    ...
    case 21: 
    command ("blush");
    command ("chat 童话快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
    break;
    case 22: 
    command ("nono");
    command ("cry");
...
varargs void drool(string msg, string who)
{
	...
	if( (strsrch(msg, "liling") >= 0)||(strsrch(msg, "童话") >= 0))
	{	
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		case 13:command("chat* ok"); break;
		case 14:command("chat* zzz");	break;
	...
	{	
		...
		case 9:	command("chat* die"); break;
		case 10:command("chat "+who+"，我真要被你气得晕过去。\n"); break;
		case 11:command("chat 打倒臭泥潭，打倒鱼儿！\n"); break;
		case 12:command("chat* hate"); break;
	...
	{	
		...
		case 3:	command("chat xixi"); break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5: command("chat* rascal");break;
		case 6:    command("chat* alarm");break;
		case 7: command("chat 嗯,"+who+"是一个好孩子.\n"); break;
		case 8:command("chat "+who+",你不会是想讨好我吧?\n"); break;
		case 9:command("chat* same");break;
		case 10:command("chat* admire");break;
	...
	switch(random(80)) {
		...
		case 13:	command("chat* faint");	break;
		case 14:	command("chat 你个小鬼。。。 。\n");	break;
		case 15:    command("chat* pk");break;
		case 16:    command("chat* sing1");break;
		case 17:    command("chat* zzz"); break;
		case 18:    command("chat* giggle");break;
		...
		case 24:	command("chat* laugh"); break;
        ...
        case 30:	command ("chat 请不要打扰我好不好?\n") ; break;
   		case 31:	command ("chat* cry2") ; break;
		case 32:	command("chat* taste"); break;
		case 33:    command("chat 嗯，谁要敢欺负我，我就宰了他！\n");break;
		case 34:    command("chat* love snowbaby");break;
		case 35:    command("chat* zzz"); break;
		case 36:    command("chat* hammer");break;
		case 37:    command("chat* nomatch");break;
	...
	{	
	   if(random(5)<3)
		...
		case 4:command("chat* cry"); break;
		case 5:command("chat* comfort"); break;
		case 6:	command("chat* sigh");	break;
		case 7:	command("chat* shrug");	break;
		case 8: command("chat* pat1"); break;
		}
		return;
        }
	}
	...
	{	
		...
		case 11:	command("chat* xixi"); break;
		case 12:	command("chat* shake");	break;
		case 13:	command("chat* zhen1"); break;
		}
		return ;
        }
	} 
		...
		case 12: command("chat* zhen1"); break;
	...
	||	(strsrch(msg, "you") >= 0)) {
		...
		case 12:	command("chat* sigh");	break;
		case 13:	command("chat* haha"); break;
	...
	{	
		...
		case 5:	command("chat* applaud");break;
		case 6: command("chat* ding"); break;
		case 7:	command("chat* laugh"); break;
		case 8: command("chat* dance" );break;
		...
		case 14:command("chat 唉，真是世风日下，人心不古啊！\n"); break;
		case 15:command("chat 我对此表示怀疑.\n"); break;
		case 16:command("chat* sigh");	break;
		case 17:command("chat* yi"); break;
		...
		switch(random(250)) {
			...
			case 3: command("chat* heng"); break;
			case 4: command("chat* fly"); break;
			...
			case 11: command("chat* angry"); break;
			...
			case 18: command("chat* noway");break;
			case 19: command("chat* bow");break;	
			case 20: command("chat 我知道了，" + msg+"\n"); break;
			case 21:command("chat* yi"); break;
			...
			case 26: command("chat* ?"); break;
			case 27: command("chat* doubt"); break;
			case 28: command("chat  我看未必.\n"); break;
			case 29: command("chat* zhen1"); break;
			case 30: command("chat  老师来啦，"+who+"你还不赶快去？\n"); break;
			case 31: command("chat "+who+",你今天怎么又逃课?\n"); break;
			case 32: command("chat* thank"); break;
			case 33: command("chat* xixi");break;
			case 34: command("chat "+who+"说得好!\n"); break;
			case 35: command("chat* fly"); break;
			case 36: command("chat "+who+",没想到你也会这样.\n"); break;
			case 37: command("chat 你无聊不无聊啊?"); break;
			case 38:  command("chat* shutup snowbaby");break;
			case 39:command("chat* careful"); break;
			case 40:command("chat 嗯 ... " + who + "说得好！\n"); break;
			case 41:command("chat* shrug");	break;
			case 42:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
			case 43:command("chat* shake");	break;
			case 44:command("chat 我对此表示怀疑.\n"); break;
			case 45: command("chat 我觉得最佳表情奖应该授予"+who+".\n"); break;
			case 46: command("chat* alarm"); break;
			case 47: command("chat* shui snowbaby"); break;
			...
			case 55: command("chat* foot"); break;
			case 56:command("chat* bow"); break; 
			case 57:command("chat 不要这样嘛!\n"); break;
			case 58:command("chat 要死啊你!"+who+"!\n"); break; 
			case 59:command("chat 打倒臭泥潭，打倒鱼儿！\n"); break;
			case 60:command("chat* ?"); break;
			case 61:command("chat 我们热爱绝地末日，绝地末日万岁！\n");break;
			case 62:command("chat* careful");break;
			case 63:command("chat* nod");	break;
			case 64:command("chat* haha"); break;
			...
			case 70:command("chat 我是个自恋狂。\n");break;
			case 71:command("chat 为什么？\n");break;
			case 72:command("chat 你烦不烦啊？\n");break;
			default:
	    if (random(10)<1) command("chat* hmm");
		else if (random(10)<1) command("chat* xixi");
	    else if (random(10)<1) command("chat* zzz");
				break;
		}
	}
}
