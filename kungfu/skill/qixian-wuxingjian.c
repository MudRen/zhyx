...
int valid_learn(object me)
{
        ...
        if ((int)me->query_skill("sword", 1)< 250 && (int)me->query_skill("sword", 1) < (int)me->query_skill("qixian-wuxingjian", 1) )
...
void do_effect(object me)
{
        ...
        lvl = lvl / 2 + me->query_skill("force")/2;
        //lvl /= 2;
        ...
        for (i = 0; i < sizeof(obs); i++)
        {
                ...
                if (me->query_skill("qixian-wuxingjian") / 2 <
                ...
                if (obs[i]->query("max_neili") + 5000 > me->query("max_neili"))
                {
                ...
                damage = me->query("max_neili")*2 - obs[i]->query("max_neili");
                if (damage < 0)
                {
