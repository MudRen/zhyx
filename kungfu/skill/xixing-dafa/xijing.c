...
int exert(object me, object target)
{
        ...
        message_combatd(HIY "$N" HIY "深深呼入一口气，运上"HIM"“吸精入体”"HIY "，顿时全身真气蒸腾，被罡劲所笼罩。\n" NOR, me);
          me->set_temp("xixing-dafa/xijing", 1);
...
void remove_effect(object me)
{
        ...
        {                
                me->delete_temp("xixing-dafa/xijing");
                tell_object(me, "你的吸精入体运行完毕，将内力收回丹田。\n");
        }
}
