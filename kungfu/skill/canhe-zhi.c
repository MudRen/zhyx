...
int get_finish(object me)
{
        ...
        {
                tell_object(me, "你不是慕容世家人氏，无法合成参合指神功。\n");
                return 0;
        }
...
int practice_skill(object me)
{
        ...
        cost = me->query_skill("canhe-zhi", 1) * 2 / 3 + 100;
...
mapping query_action(object me, object weapon)
{
        ...
        if (random(4) == 1 && me->query("neili") > 500)
        {
                me->add("neili", -30);
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
        ...
        if (damage_bonus < 150 || lvl < 140) return 0;

        if (damage_bonus / 5 > victim->query_dex()
            && random(2)==1 && me->query("neili") > 65)
        {
                me->add("neili", -80);
