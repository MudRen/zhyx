...
int perform(object me, object target)
{
        ...
        if (me->query_skill_mapped("sword") != "shangqing-jian" && me->query_skill_mapped("parry") != "shangqing-jian" )
        ...
        damage = (int)me->query_skill("shangqing-jian")*2;
        damage += random(damage / 2);

        ap = me->query_skill("shangqing-jian",1);
