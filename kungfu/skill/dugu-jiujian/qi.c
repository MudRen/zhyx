...
int perform(object me, object target)
{
        ...
        if (userp(me) && ! me->query("can_perform/dugu-jiujian/qi"))
		...
		if (me->query("can_learn/dugu-jiujian/nothing"))
                        ap = me->query_skill("sword") + me->query_skill("parry") + me->query_skill("martial-cognize",1);
		else
...
string final(object me, object target, int ap)
{
	 if (me->query("can_learn/dugu-jiujian/nothing"))
        ...
        call_out("poqi_end", 5 + random(10), me, target);
