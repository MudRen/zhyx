...
string *parry_msg = ({
	"只见$N默运南海玄功，真气护住全身。$n一招击中$N，只觉落手处劲力石沉大海，大感惊讶，连忙退回。 \n",
        "但见$n一招攻出，$N怒吼一声，不退反进，巨涛般的气墙竟将$n这招逼回。\n",
        "只见$N全身真气流动，一股罡气护住全身，已将$n所有进攻招式挡在罡气之外。\n",
        "但见$N不退反进，大喝一声，将$n的招式逼回。\n",
});
...
int valid_learn(object me)
{
        ...
        if (me->query("character") != "狡黠多变")
                return notify_fail("你发觉南海玄功过于灵活多变，变"
                                   "幻无常，自己实在领会不了。\n");
        ...
        if (me->query("int") > 15)
                return notify_fail("你试图潜心修炼南海玄功，却突然觉"
                                   "得以前变幻无常，看来是悟性过高，"
                                   "难以领悟。\n");
