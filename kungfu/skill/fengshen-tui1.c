...
mixed hit_ob(object ob,object me, object victim, int damage_bonus)
{
        string name1, name2, weapon, sk1, sk2;
        ...
        if (sk1 > 100)
        {
                return NOR + HIR "$N¾¹ÔËÆðÅÅÔÆÕÆ·¨£¬½«Æä°ÂÒå·¢»ÓµÃÁÜÀì¾¡ÖÂ£¬$n¾¹Ò»Ê±ÕÒ²»³öÆÆÕÀ£¬´¦´¦ÊÜÖÆ£¡\n" NOR;
