	 ...
	 if ( me->query("can_learn/dugu-jiujian/nothing") && damage_bonus > 150 )
        {
                ...
                return random(2) ? HIR "$N一抖手中长剑，瞬间"+HIW"漫天剑气"+HIR "犹如" + HIY "夜雨" HIG "流星" NOR + HIR"，从$n"
					               HIR  "身上透体而过...\n" NOR:
                                   
                                   HIR "霎时只见寒光一闪，一道"+HIY"剑气" + HIR "从$n"								  
                                   HIR "身上堪堪划过，"+HIR"鲜血顿时喷涌而出...\n" NOR;
        }     
...
int practice_skill(object me)
{
	...
	if (me->query("family/family_name") != "华山派")
	    return notify_fail("独孤九剑只能通过「总诀式」来演练或研究提高。\n");
	else
	 	{
	 		object weapon;
