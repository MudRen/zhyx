...
int perform(object me, object target)
{
        ...
        ap = me->query_skill("force") + me->query_skill("tanqin-jifa",1);
        an = me->query("max_neili")+me->query_skill("tanqin-jifa",1);
        dn = target->query("max_neili")+me->query_skill("tanqin-jifa",1);
