...
int perform(object me, object target)
{
        ...
        ap = me->query_skill("force")/2 + me->query_skill("tanqin-jifa",1) ;
        dp = target->query_skill("force")/2 + target->query_skill("tanqin-jifa",1);
        ...
        {
                damage = skill * 2 + me->query_skill("tanqin-jifa",1);
