...
int recognize_apprentice(object me, string skill)
{
    ...
    if (me->query("family/family_name") == query("family/family_name"))   
    {
        if (skill != "xiantian-gong" && skill != "taoism" && skill != "unarmed" && skill != "jingluo-xue" && skill != "sanscrit" && skill != "buddhism")
	{
	    command("say 这些还是向你的师父学吧，老衲只能传授道学心法和先天功给你。");
	    return -1;
	}
    }
...
mixed ask_skill1()
{
    ...
    if (me->query_skill("jingluo-xue", 1) < 180)
	return "你对经络学的了解还不透彻，研究透了再来找我吧。";

    if (me->query_skill("yiyang-zhi", 1) < 220)
...
mixed ask_skill2()
{
    ...
    me = this_player();
    if (me->query("can_perform/yiyang-zhi/jian"))
	return "你一阳指练到这种境界，老衲已没什么可教的了。";
	...
	me->improve_skill("yiyang-zhi", 1500000);
    me->improve_skill("martial-cognize", 1500000);
    me->set("can_perform/yiyang-zhi/jian", 1);
