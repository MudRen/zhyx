...
void create()
{
        ...
        set_skill("huashan-jian", 3500);
        set_skill("fanliangyi-dao", 3500);
        set_skill("huashan-xinfa", 3500);
        set_skill("zixia-shengong", 3500);
        set_skill("huashan-quan", 3500);
        set_skill("poyu-quan", 3500);
        set_skill("huashan-zhang", 3500);
        set_skill("hunyuan-zhang", 3500);
        set_skill("huashan-shenfa", 3500);
        set_skill("pixie-jian", 3500); 
