...
void create()
{
        ...
        set_skill("force", 350);
        set_skill("shenlong-xinfa", 350);
        set_skill("huaxue-shengong", 350);
        set_skill("dodge", 330);
        set_skill("yixingbu", 330);
        set_skill("hand", 340);
        set_skill("shenlong-bashi", 340);
        set_skill("strike", 340);
        set_skill("huagu-mianzhang", 340);
        set_skill("parry", 350);
        set_skill("staff", 350);
        set_skill("sword", 350);
        set_skill("shedao-qigong", 350);
        set_skill("unarmed", 350);
        set_skill("literate", 320);
        set_skill("medical", 370);
        set_skill("shenlong-mixin", 370);
