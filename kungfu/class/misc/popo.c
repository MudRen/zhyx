...
void create()
{
        ...
        set_skill("force", 580);
        set_skill("yunv-xinfa", 580);
        set_skill("sword", 570);
        set_skill("yunv-jian", 570);
        set_skill("quanzhen-jian", 570);
        set_skill("dodge", 550);
        set_skill("yunv-shenfa", 550);
        set_skill("parry", 570);
        set_skill("unarmed",550);
        set_skill("meinv-quan", 550);
        set_skill("strike", 560);
        set_skill("fireice-strike", 560);
        set_skill("literate", 180);
        set_skill("taoism", 340);
        set_skill("medical", 270);
        set_skill("yunv-xinjing", 570);
        set_skill("throwing", 560);
        set_skill("yufeng-zhen", 560);
