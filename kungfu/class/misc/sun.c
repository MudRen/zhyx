...
LONG );
	...
	set("attitude", "friendly");
        ...
        set("int", 200);
        set("con", 200);
        set("dex", 200);set("chat_chance_combat", 150);
	set("chat_msg_combat", ({
		(: exert_function, "powerup" :),(: perform_action, "strike.bei" :),
	...
	set_skill("huntian-baojian", 2800);
	set_skill("dabei-zhang", 3000);
        set_skill("zhuangzi-wu", 3000);		
...
void fight_ob(object ob)
{
	if (is_fighting(ob))
        ...
        message_vision(HIY "$N" HIY "哈哈一笑，对着$n就是一棒！\n" NOR,
		       this_object(), ob);
...
{
        string *ob_list = ({
                "/u/dgdg/fuben/obj/duejindan",
                "/u/dgdg/fuben/obj/magic_item/fuxiqin",
                "/u/dgdg/fuben/obj/wudaosheli",
        });
        object ob;
...
void random_attack()
{
	    ...
	    query("jing") < query("max_jing") * 3 / 5)
	{
		...
		message_combatd(HIM "$N" HIM "施展九龙化伤术，体力得到了完全恢复！\n" NOR,
				this_object());
