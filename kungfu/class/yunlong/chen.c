...
int accept_object(object me, object ob)
{
		...
		{
                command("say 好吧！");
                command("say 我也没有什么可帮你的，就传你一套凝血神爪吧，这是集我毕生精力所创，希望你能将其发扬光大。");

                if (me->query_skill("ningxue-shenzhao", 1) < 50)
                me->set_skill("ningxue-shenzhao", 5); 

                tell_object(me, HIR "你学会了凝血神爪！\n" NOR); 
                command("say 就教你这么多吧，剩下的自己多多练习。"); 
                destruct(ob);
                return -1;
		} else
		{
