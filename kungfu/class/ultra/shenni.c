...
void create()
{
        ...
        set_skill("staff", 3000);
        set_skill("bluesea-force", 3000);
...
int recognize_apprentice(object me, string skill)
{
	...
	if (skill == "martial-cognize")
        ...
        me->set_temp("can_learn/shenni/bluesea-force", 1);
        command("nod");
        command("say 不错，我教你我的绝学南海玄功，能不能学，"
                "就看你的造化了！");
        return 1;
}
