...
inherit CLASS_D("generate") + "/chinese_sp";
...
void set_from_me(object me)
{
	...
	if (query_skill("count",1) >500)	set_skill("count", 400);
	if (query_skill("taoism",1) >500)	set_skill("taoism", 400);
	if (query_skill("buddhism",1) >600)	set_skill("buddhism", 600);
	if (query_skill("tanqin-jifa",1) >500)	set_skill("tanqin-jifa", 500);
	if (query_skill("jingluo-xue",1) >500)	set_skill("jingluo-xue", 350);
	if (query_skill("qimen-wuxing",1) >500)	set_skill("qimen-wuxing", 350);
