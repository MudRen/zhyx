...
ho);
        ...
        } else
        {
                ...
                NPC_D->place_npc(ob, who->query("combat_exp") < 500000  ? ({ "大
理一带", "终南山", "关外", "西域" }) :
                                     who->query("combat_exp") < 800000 ? ({ "大理
一带", "终南山", "西域" }) : 0);
				...
				tell_object(who, me->name() + "对你道：“虽然我们出家人以" +
					...
					NOR "在" + place + "作恶"
				        "多端，你去把他除了，提头来见。”\n");
                        	...
                        	tell_object(who, me->name() + "对你道：“" HIR + ob->na
me() +
					NOR "这个败类打家劫舍，无恶不作，"
                                	"听说他最近在" + place +
					"，你去除掉他，提头来见我！”\n");
                ...
                {
                        ob->set("shen", ob->query("combat_exp") / 2000);
                        tell_object(who, me->name() + "对你道：“" HIR + ob->nam
e() + NOR
                                "这个所谓大侠屡次和我派作对，"
                                "听说他最近在" + place + "，你去宰"
                                "了他，提头来见！”\n");
			...
			special = "/clone/gift/tianxiang";
                ...
                if (quest_count >= 1000)
                {
                        msg += "$N深深叹了口气，道：“想不到你连着上千次"
                               "任务无一失手，看来我们" + me->query("family/fami
ly_name") +
                               "真是后继有人啊！”\n";
...
ase["experience"]) * 2 / 3;
        ...
        case "letter":
                message_vision("$N叹口气，看了看$n道：“连这点小事都干不了？算了
吧。”\n",
                               me, who);
