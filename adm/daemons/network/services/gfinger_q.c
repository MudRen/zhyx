...
// modify by bigfoot@FSYY (97-11-18)
...
void incoming_request(mapping info)
{
	...
	if (info["NAME"] && info["PORTUDP"] && info["PLAYER"]) {
		...
		reply = FINGER_D->finger_user(lower_case(info["PLAYER"]),1);
