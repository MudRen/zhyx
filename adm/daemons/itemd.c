...
int do_san(object me, object item)
{
        ...
        {
               // if (! count)
                 //       return notify_fail("你应该先寻求四位高手协助你先行圣化" +item->name() + "。\n");
...
mixed weapon10lv_hit_ob(object me, object victim, object weapon, int damage_bonus)
{
        ...
        case "lighting":
                ...
                case 1:
                        ...
                        break;
                case 2:
                        msg = HIY + weapon->query("name") + HIY "喷出一团炽白的光球，直奔$n"
                ...
                case 3:
                        ...
                        break;
                case 4:
                        msg = HIY + weapon->query("name") + HIY "暴出漫天夹杂响雷的闪电直击而来，$n"
        ...
        case "cold":
                ...
                case 2:
                        ...
                        break;
                case 3:
                        msg = HIB + weapon->query("name") + HIB "暴出漫天冰锥直射而来，$n"
                              HIB "转眼间已然成了蜂窝。\n" NOR;
                        break;
                case 4:
                        msg = HIB "忽然间" + weapon->name() + HIB
        ...
        case "fire":
                ...
                case 2:
                        ...
                        break;
                case 3:
                        msg = HIR + weapon->query("name") + HIR "暴出漫天通红的火球直击而来，$n"
                              HIR "被置身一片火海，惨叫连连。\n" NOR;
                        break;
                case 4:
        ...
        case "magic":
                ...
                case 1:
                        ...
                        break;
                case 2:
                        msg = HIM + weapon->query("name") + HIM "喷出漫天浓香的五彩雾气，$n"
                              HIM "只觉醉生梦死，全身使不出力量来。\n" NOR;
                        break;
                case 3:
                        msg = HIM + weapon->query("name") + HIM "喷出漫天五彩迷雾扑面而来，$n"
                              HIM "周身被五彩迷雾围在其中，手无敷鸡之力。\n" NOR;
                        break;
                case 4:
                        msg = HIM + weapon->name() + HIM "蓦的冒出几丝略带清香的白烟飘然而过，$n"
                              HIM "顿时全身无力。\n" NOR;
                        break;
                default:
